...
//           _SettingsTile(
//             icon:      Icons.bluetooth_rounded,
//             iconColor: ble.isConnected ? AppTheme.secondary : AppTheme.textSecondary,
//             title:    'AF-Screen Device',
//             subtitle: ble.isConnected
//                 ? 'Connected — ${ble.device?.platformName ?? "AF-SCREEN"}'
//                 : 'Not connected',
...
//           '${StorageService.measurementCount} stored readings. '
...
//               ScaffoldMessenger.of(context).showSnackBar(
//                 const SnackBar(
//                     content: Text('All measurement data cleared.')),
//               );
//             },
//             child: const Text('Delete All'),
//           ),
...
//         SnackBar(
//           content: Text(
//               'Reminder set for ${settings.reminderTime.format(context)} daily.'),
...
//     // If reminder is already on, reschedule with new time
//     if (settings.reminderEnabled) {
//       await ReminderService.scheduleDailyReminder(picked);
//       if (!context.mounted) return;
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text('Reminder updated to ${picked.format(context)} daily.'),
//           backgroundColor: AppTheme.secondary,
//           behavior: SnackBarBehavior.floating,
//         ),
//       );
...
//                 : 'Get a daily nudge to take your reading',
//             style: Theme.of(context)
//                 .textTheme
//                 .bodyMedium
//                 ?.copyWith(fontSize: 12),
...
//                   Expanded(
//                     child: Text(
//                       'You will receive a notification every day at '
//                       '${time.format(context)} to take your AF measurement.',
//                       style: Theme.of(context)
//                           .textTheme
//                           .bodyMedium
