      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (ble.isConnected)
              Text(
                'Connected to ${ble.device?.platformName ?? "AF-SCREEN"}',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...[
          ('1', 'Power on the AF-Screen device', Icons.power_settings_new_rounded),
          ('2', 'Wait for the blue LED to blink slowly (idle mode)', Icons.light_mode_rounded),
          ('3', 'Tap "Scan for Device" above', Icons.search_rounded),
          ('4', 'Place your fingers on the pads when prompted', Icons.touch_app_rounded),
        ].map((step) => Padding(
