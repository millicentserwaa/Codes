...
class AfResultBadge extends StatelessWidget {
  ...
  Color get _color {
    switch (result) {
      case AfResult.normal:       return AppTheme.afNormal;
      case AfResult.possibleAF:   return AppTheme.afPossible;
      case AfResult.inconclusive: return AppTheme.afInconclusive;
    }
  }

  IconData get _icon {
    switch (result) {
      case AfResult.normal:       return Icons.check_circle_rounded;
      case AfResult.possibleAF:   return Icons.warning_rounded;
      case AfResult.inconclusive: return Icons.help_rounded;
    }
  }
...
class StrokeRiskChip extends StatelessWidget {
  ...
  Color get _color {
    switch (risk) {
      case StrokeRisk.low:      return AppTheme.riskLow;
      case StrokeRisk.moderate: return AppTheme.riskModerate;
      case StrokeRisk.high:     return AppTheme.riskHigh;
    }
  }
...
class MeasurementListTile extends StatelessWidget {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _pill('CV ${measurement.cv.toStringAsFixed(2)}',
                          measurement.cv >= 0.15
                              ? AppTheme.warning
                              : AppTheme.secondary),
                      const SizedBox(width: 6),
                      _pill('HR ${measurement.heartRate.toStringAsFixed(0)} bpm',
                          AppTheme.primary),
                    ],
                  )
                ],
  ...
  IconData _afIcon(AfResult r) {
    switch (r) {
      case AfResult.normal:       return Icons.favorite_rounded;
      case AfResult.possibleAF:   return Icons.warning_rounded;
      case AfResult.inconclusive: return Icons.help_rounded;
    }
  }
