...
// class HistoryScreen extends StatefulWidget {
//   // BleService must be passed in so we listen to the SAME instance
//   // that is doing the syncing (not a new one)
...
//     // Listen for new measurements coming in via BLE sync
//     // Every time one arrives, reload the full list from Hive
...
//     final minY = data.map((m) => m.heartRate).reduce((a, b) => a < b ? a : b) - 10;
//     final maxY = data.map((m) => m.heartRate).reduce((a, b) => a > b ? a : b) + 10;
